  ...
  async _keywordSearch(选项 = {}) {
    ...
    return new Promise((resolve, reject) => {
      ...
      request.onsuccess = () => {
        ...
        const 搜索词 = 关键词?.toLowerCase().trim();
        if (搜索词) {
          const 停用词 = new Set(['的','了','是','在','我','你','他','她','它','们','这','那','有','不','就','也','都','还','又','很','把','被','让','给','到','和','与','或','但','而','及','从','对','比','用','以','为','么','呢','吧','啊','吗','呀','嗯','哦','想','要','会','能','可','以','什么','怎么','哪个','多少','几','点','些','个','一','里','外','内','中','上','下','大','小','多','少','好','坏','没','无','做','去','来','得','说','看','知','道','时','候','年','月','日','天','地','人','事','物','理','等','于','之','其','所','将']);
