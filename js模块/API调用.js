...
const _备忘录工具列表 = [
  ...
  },
  {
    ...
    "function": {
      "name": "record_person",
      "description": "【人物关系记录工具】当你从对话中识别出值得记住的人物（用户提到的人名、关系、背景等），用此工具记录到📇人物关系文件夹。系统按类别自动归档（亲属/朋友/同事/其他），每个类别一条备忘录，新信息追加。适用场景：用户提到家人、朋友、同事、客户等真实人物；用户明确说'记住XX是我XX'。不要用于虚构角色或AI自己。",
      "parameters": {
        "type": "object",
        "properties": {
          "name": {
